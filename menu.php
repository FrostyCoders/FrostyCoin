<?php
      ...
      echo "<div class='nav-zawartosc nav-js'>";
      echo "<div class='nav-zakladka'>";
      echo $row['position_name'];
      echo "<div class='nav-podkategorie nav-js-p'>";
      ...
      echo "<img class='nav-iconsize' src='fp-admin/img-db/menu_icons/".$row['position_icon_path']."'>";
      echo "</div>";
      echo "</div>";
      }
?>