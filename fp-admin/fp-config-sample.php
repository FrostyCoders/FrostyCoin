...
*/
$host = ''; /** Nazwa lub adres hosta z serwerem bazy danych mysql */
$username = ''; /** Użytkownik bazy danych z uprawnieniami do tworzenia baz danych oraz do wykonywania zapytań na bazie danych. */
$password = ''; /** Hasło użytkownika bazy danych.*/
$dbname = ''; /** Nazwa bazy danych która zostanie utworzona a pózniej będzie z niej korzystał system. */
